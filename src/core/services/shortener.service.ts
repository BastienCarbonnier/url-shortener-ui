...
export const getFullUrl = async (shortUrlId: string): Promise<BackendResponse> => {
  return (await axios.get(`${import.meta.env.VITE_URL_SHORTNER_API_URL}/url-shortener/`, { headers, params: { shortUrlId }})).data;
}